...
Eventify is a full-stack web application that allows event organizers to create, manage, and promote events, while attendees can discover, register, and participate.
It demonstrates Object-Oriented Programming (OOP) principles and is built using Node.js, Express, PostgreSQL, and React.
...
Eventify streamlines the entire event lifecycle — from creation to post-event analytics — for multiple user roles.
The system is designed to handle different types of events such as conferences, concerts, workshops, and corporate programs.
...
🔸 Export Database (Create Dump)
pg_dump -U aichurekasylbek -d eventify_db > eventify_dump.sql
...
🎓 Techtonica Graduate Project  Full-Stack OOP Event Management Platform
